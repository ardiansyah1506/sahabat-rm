...
<div class="mb-8">
    <div class="flex items-center space-x-3 mb-2">
        ...
        <h1 class="text-3xl font-bold text-gray-800">Tugaskan Asisten</h1>
    </div>
    <p class="text-gray-500">Pilih asisten dan jelaskan tugas laboratorium yang harus diselesaikan.</p>
</div>

<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden max-w-2xl">
    <form action="{{ route('admin.tasks.store') }}" method="POST" class="p-6 md:p-8 space-y-6">
        @csrf
        ...
        <div>
            ...
            <textarea name="description" rows="5" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-medical-500 focus:border-medical-500 outline-none transition" placeholder="Jelaskan instruksi tugas dengan detail...">{{ old('description') }}</textarea>
